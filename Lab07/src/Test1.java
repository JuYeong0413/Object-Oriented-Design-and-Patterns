...
class Test1 {
	...
	public static void main(String[] args) {
		...
		if(observedPatch.eat()) System.out.println(" and Patch eats");
		else System.out.println(" and Patch decides not to eat");
		...
		if(observedRover.eat()) System.out.println("Rover eats");
		else System.out.println("Rover decides not to eat");
		
		System.out.println("\nJim stops observing Rover\n");
		observedRover.deleteObserver(jim);
		
		System.out.println("Rover looks at food again");
		if(observedRover.eat()) System.out.println(" and Rover eats");
		else System.out.println(" and Rover decides not to eat");
